...
### 3. 과금 모델 (현재: 무료)
- **현재**: 로그인하면 무제한 무료 (오픈 기념)
- 결제 관련 코드는 주석 처리로 보존됨 (유료화 시 복원 가능)
- 참고 가격표 (유료화 시): 스타터 ₩9,900/월, 프로 ₩29,000/월
...
- [x] 크레딧 시스템 DB 설계 (주석 처리됨 - 유료화 시 복원)
- [x] 무료 1회 변환 로직 → 현재 무제한 무료
- [x] 포트원 + KG이니시스 연동 (주석 처리됨 - 유료화 시 복원)
- [x] 크레딧 패키지 구매 플로우 (주석 처리됨 - 유료화 시 복원)
- [x] 결제 완료 웹훅 처리 (주석 처리됨 - 유료화 시 복원)
- [x] 글 톤/스타일 커스터마이징
- [x] i18n 영어/한국어 전환
